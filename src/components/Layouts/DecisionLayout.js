      ...
      {!decisionStarted && decisionEnded &&(
        <div>
          ...
          <div className="flex-box flex-center">
            ...
            <ul><li>What are some of the ethical concerns about researching prisoners?</li>
        <li>What specifically might pose a risk to prisoners if they are asked to divulge information about
their religion/spirituality? </li>
        <li>To analyze the survey results, do we need to know if the inmate regularly attended a place of worship before incarceration? Why or why not?</li>
        ...
        <li>The BOP provided the following 25 responses to be used for the question, “What is your religion
today, if any?”
<ul><li>Adventist</li>
<li>Atheist</li>
<li>Buddhist</li>
<li>Catholic</li>
<li>Christian Non-Trinitarian</li>
<li>Christian Science</li>
<li>Church of Christ</li>
<li>Church of Jesus Christ of Latter-day Saints</li>
<li>Hindu</li>
<li>Humanist</li>
<li>Islam</li>
<li>Jehovah Witness</li>
<li>Jewish</li>
<li>Messianic</li>
...
<li>Other</li>
<li>Orthodox Christian</li>
<li>Pagan</li>
<li>Pentecostal</li>
<li>Protestant Christian</li>
<li>Rastafarian</li>
<li>Santeria</li>
</ul><p>Contrast this with the standard social science questionnaire list of religions used by the Pew
Research Center: “What is your present religion, if any? Are you Protestant, Roman Catholic,
Mormon, Orthodox such as Greek or Russian Orthodox, Jewish, Muslim, Buddhist, Hindu, atheist,
agnostic, something else, or nothing in particular?” What might some of the intersectional reasons be for including a broader range of responses on the prison survey as
opposed to the general population survey?</p></li>
        </ul>
